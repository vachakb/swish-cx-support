...
// Handlers build a grounded, deterministic base reply. With a real model we polish it for warmth;
// the mock returns it unchanged so key-free runs are still solid. Facts are never altered.
